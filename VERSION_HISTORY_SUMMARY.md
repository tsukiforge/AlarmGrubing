...
* **Health Social Enforcement**: Foreground service monitoring real-time dengan UsageStatsManager, overlay kunci (TYPE_APPLICATION_OVERLAY), verifikasi PIN, AlarmManager scheduler, dan BOOT_COMPLETED receiver.
